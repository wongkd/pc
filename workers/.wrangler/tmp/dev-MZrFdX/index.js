...
var loginSchema = external_exports.object({
  ...
  password: external_exports.string().min(1, "\u5BC6\u7801\u4E0D\u80FD\u4E3A\u7A7A")
});
var registerSchema = external_exports.object({
  email: external_exports.string().email("\u90AE\u7BB1\u683C\u5F0F\u4E0D\u6B63\u786E"),
  password: external_exports.string().min(6, "\u5BC6\u7801\u81F3\u5C116\u4F4D")
});
var changePwdSchema = external_exports.object({
  oldPassword: external_exports.string().min(1, "\u65E7\u5BC6\u7801\u4E0D\u80FD\u4E3A\u7A7A"),
  newPassword: external_exports.string().min(6, "\u65B0\u5BC6\u7801\u81F3\u5C116\u4F4D")
});
...
var app2 = new Hono2();
var addItemSchema = external_exports.object({
  items: external_exports.array(external_exports.object({
    category: external_exports.string().min(1),
    name: external_exports.string().min(1),
    price: external_exports.number().min(0),
    image: external_exports.string().optional().default(""),
    platform: external_exports.string().optional().default("")
  })).min(1)
});
...
// src/routes/normalize.ts
var app4 = new Hono2();
var normalizeSchema = external_exports.object({
  titles: external_exports.array(external_exports.string()).min(1)
});
app4.post("/", authMiddleware, zValidator("json", normalizeSchema), async (c) => {
  const { titles } = c.req.valid("json");
  const items = titles.map((title) => {
    const cleaned = title.replace(/\s+/g, " ").replace(/（/g, "(").replace(/）/g, ")").trim();
...
var app5 = new Hono2();
var saveTemplateSchema = external_exports.object({
  name: external_exports.string().min(1, "\u6A21\u677F\u540D\u79F0\u4E0D\u80FD\u4E3A\u7A7A"),
  data: external_exports.any()
});
var deleteTemplateSchema = external_exports.object({
...
app5.post("/", authMiddleware, zValidator("json", saveTemplateSchema), async (c) => {
  const userId = c.get("userId");
...
app5.delete("/", authMiddleware, zValidator("json", deleteTemplateSchema), async (c) => {
  const userId = c.get("userId");
...
// .wrangler/tmp/bundle-wXyYYk/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-wXyYYk/middleware-loader.entry.ts
